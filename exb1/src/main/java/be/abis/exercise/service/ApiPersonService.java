...
//        return persons;
        ResponseEntity<ArrayList<Person>> responseEntity = restTemplate.exchange(baseUrl, HttpMethod.GET, null, new ParameterizedTypeReference<ArrayList<Person>>(){});
        ArrayList<Person> persons = responseEntity.getBody();
        return persons;
    }
